      ...
      <div className="container">
        ...
        <div className="cyber-testi-head">
          <div className="cyber-section-eyebrow">
            ...
            <span className="label">PEER_REVIEW</span>
            <span className="bracket">]</span>
          </div>
          <h2 className="cyber-testi-title">
            What Colleagues &amp; <span className="grad">Clients Say</span>
          </h2>
          <p className="cyber-testi-lede">
            Feedback from security leaders, architects, and development managers
            across IBM and enterprise clients.
          </p>
        </div>
        ...
        <div className="cyber-testi-stage">
          {/* Prev */}
          <div
            className="cyber-testi-card is-prev"
            onClick={prev}
            role="button"
            aria-label="Previous testimonial"
          >
            <p className="cyber-testi-quote">
              {testimonials2[getIndex(-1)].text}
            </p>
            <div className="cyber-testi-author">
              <div className="cyber-testi-avatar">
                {testimonials2[getIndex(-1)].name.charAt(0)}
              </div>
              <div>
          ...
          <div className="cyber-testi-card is-active">
            ...
            <div className="cyber-testi-author">
              <div className="cyber-testi-avatar">
                {testimonials2[active].name.charAt(0)}
              </div>
              <div>
          ...
          {/* Next */}
          <div
            className="cyber-testi-card is-next"
            onClick={next}
            role="button"
